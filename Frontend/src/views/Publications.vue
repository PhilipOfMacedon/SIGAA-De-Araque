<template>
  <div class="publications">
    <v-container fluid>
      <h1 class="display-1 font-weight-light blue-grey--text text--darken-4 ml-3">Publicações</h1>
      <v-card flat>
            ...
            >
              ...
              <v-card>
                <v-card-text class="font-weight-regular px-2 text-md-center">
                  ...
                  <div>
                    <v-chip color="amber" class="darken-3" text-color="white">Área de conhecimento</v-chip>
  ...
  computed: {
    filteredPublications: function() {
      return this.publications.filter(publication => {
        ...
        if (this.search.optionSelected.filter === "area")
          projectValue = publication.area;
        else if (this.search.optionSelected.filter === "author")
          projectValue = publication.author;
        else if (this.search.optionSelected.filter === "date")
          projectValue = publication.release_date;
